...
for instruction in read_input_file("input.txt"):
    ...
    if instruction[0] == 'forward':
        instructions_summary['depth'] += (instructions_summary['down'] - instructions_summary['up']) * instruction[1]

print(instructions_summary['forward'] * instructions_summary['depth'])